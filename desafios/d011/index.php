...
<head>
    ...
    <title>Calcular Porcentagem</title>
...
<body>
    ...
    <section>
        ...
        <p>O produto que custava R$<?=number_format($preco, 2, ",", ".")?>, com <strong><?=$reaj?> de aumento</strong> vai passar a custar <strong>R$<?=number_format($novoPreco, 2, ",", ".")?></strong> a partir de agora.</p>
    </section>
